...
module.exports = asyncRequire([
  'moment'
], function(moment, resolve, reject) {
...
.ant-pro-pages-account-projects-cardList .ant-card-meta-title {
  margin-bottom: 4px;
}
.ant-pro-pages-account-projects-cardList .ant-card-meta-description {
  height: 44px;
  overflow: hidden;
  line-height: 22px;
}
...
.ant-pro-pages-account-projects-cardList .cardItemContent .ant-pro-avatar-list {
  flex: 0 1 auto;
}
</style>
