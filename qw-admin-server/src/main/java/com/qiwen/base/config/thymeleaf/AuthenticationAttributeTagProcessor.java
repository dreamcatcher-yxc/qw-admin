...
import static com.qiwen.base.config.thymeleaf.SystemDialect.AUTH_ATTRIBUTE_TAG_NAME;
import static com.qiwen.base.config.thymeleaf.SystemDialect.USER_ATTRIBUTE_TAG_PREFIX;

@Slf4j
@Component
public class AuthenticationAttributeTagProcessor extends AbstractAttributeTagProcessor {

        public AuthenticationAttributeTagProcessor() {
            super(
                    TemplateMode.HTML, // 此处理器将仅应用于HTML模式
                    USER_ATTRIBUTE_TAG_PREFIX,     // 要应用于名称的匹配前缀
                    null,              // 无标签名称：匹配任何标签名称
                    false,             // 没有要应用于标签名称的前缀
                    AUTH_ATTRIBUTE_TAG_NAME,         // 将匹配的属性的名称
                    true,              // 将方言前缀应用于属性名称
